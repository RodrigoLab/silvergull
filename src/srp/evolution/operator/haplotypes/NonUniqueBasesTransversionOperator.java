...
public class NonUniqueBasesTransversionOperator extends AbstractMultiOperator {


	public static final String OPERATOR_NAME = NonUniqueBasesTransversionOperator.class.getSimpleName();
	public static final OperationType OP = OperationType.MULTI;
	

	
	public NonUniqueBasesTransversionOperator(HaplotypeModel haplotypeModel, int length, CoercionMode mode) {
